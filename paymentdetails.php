...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="paymentdetails.html"><em class="fa fa-clone">&nbsp;</em> Payment(EWI) Details</a></li>
			<li class="active"><a href="report.html"><em class="fa fa-clone">&nbsp;</em> Report</a></li>
								...
								<table class="table table-condensed table-bordered table-hover">
									<thead>
										<tr>
											...
											<th class="">Cust_ID</th>
											<th class="">Receipt_no</th>
											<th class="">Receipt_date</th>
										</tr>
									</thead>
									<tbody>
